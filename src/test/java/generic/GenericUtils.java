...
public class GenericUtils extends BaseTest {
	...
	public static void gSelectByVisileText(WebElement element,String v) {
		Select select=new Select(element);
	...
	public static void sortListBox(WebElement element) {
		...
		//to fetch the text values from the options
		...
		Collections.sort(ar);
		//to compare the elements and print the result
